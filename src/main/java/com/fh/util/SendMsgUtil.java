...
public class SendMsgUtil {
    ...
    private static final String
            APP_KEY="c80f885005e7db8dab455a4159a362bb";
    //网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
    private static final String APP_SECRET="191816196a9a";
    //随机数
    private static final String NONCE="123456";
    //短信模板ID
    private static final String TEMPLATEID="14833348";
    //手机号
    private static final String MOBILE="13583085601";
    //验证码长度，范围4～10，默认为4
